...
import Logogithub from '../img/_github_icon-icons.com_65799.png'
    ...
    return (
        ...
        <div className="footer-content">
            ...
            <div className="social-media">
                ...
                <a href="https://www.youtube.com/"><img src= {Logoinstagram} alt="YouTube"/></a>
                <a href="https://github.com/BeJotaTriple/Delizia-Gourmet.git/"><img src= {Logogithub} alt="Instagram"/></a>
            </div>
        </div>
